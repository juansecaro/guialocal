...
class IncidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create incident" do
    assert_difference('Incident.count') do
      post incidents_url, params: { incident: { info: @incident.info, status: @incident.status, subject: @incident.subject, user_id: @incident.user_id } }
    end
  ...
  test "should update incident" do
    patch incident_url(@incident), params: { incident: { info: @incident.info, status: @incident.status, subject: @incident.subject, user_id: @incident.user_id } }
